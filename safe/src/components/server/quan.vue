  ...
  <div class="quan">
    <div class="head">
      <div class="header">
        ...
        <div class="center">
          <span v-show="isShow">圈子</span>
          <span v-show="!isShow">车主圈</span>
        </div>
        <div class="right">
          <p v-show="isShow"><img src="static/img/healthycircle/1.png" alt=""><img src="static/img/healthycircle/2.png" alt=""></p>
        </div>
      </div>
    ...
    <div class="con">
      <mt-tab-container v-model="actived" swipeable>
        ...
        <mt-tab-container-item id="car">
          ...
          <div class="tiao"></div>
          <div class="car_nav" :class="{isTage:isShow==false}">
            <ul>
