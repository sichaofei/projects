    ...
    <div class="con">
      <mt-tab-container v-model="active" swipeable>
        ...
        <mt-tab-container-item id="财富">
          <mt-cell-swiper title="2 ">财富</mt-cell-swiper>
        </mt-tab-container-item>
        <mt-tab-container-item id="健康">
          <mt-cell-swiper title="3 ">健康</mt-cell-swiper>
        </mt-tab-container-item>
        <mt-tab-container-item id="生活">
          <mt-cell-swiper title="4 ">生活</mt-cell-swiper>
        </mt-tab-container-item>
        <mt-tab-container-item id="本地">
          <mt-cell-swiper title="5 ">本地</mt-cell-swiper>
        </mt-tab-container-item>
        <mt-tab-container-item id="我的">
          <mt-cell-swiper title="6 ">我的</mt-cell-swiper>
        </mt-tab-container-item>
      </mt-tab-container>
    </div>
  </div>
